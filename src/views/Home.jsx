...
import { FaRobot, FaRocket, FaTools } from "react-icons/fa";
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white p-8 rounded-2xl shadow-xl">
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="text-center">
                        <HiShieldCheck className="w-12 h-12 text-cyan-500 mx-auto mb-3" />
                        <h3 className="font-semibold text-accent">
                          Reliability
                        </h3>
                        <p className="text-sm text-gray-600">
                      ...
                      <div className="text-center">
                        <HiUsers className="w-12 h-12 text-cyan-500 mx-auto mb-3" />
                        <h3 className="font-semibold text-accent">
                          Collaboration
                        </h3>
                        <p className="text-sm text-gray-600">
                      ...
                      <div className="text-center">
                        <HiTrendingUp className="w-12 h-12 text-cyan-500 mx-auto mb-3" />
          ...
          <div className="flex flex-col items-center py-32 px-6 lg:px-12 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-7xl w-full">
              ...
              <Fade direction="left" triggerOnce>
                ...
                >
                  <div className="absolute -top-6 left-8 p-4 bg-gradient-to-r from-accent to-blue-700 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <Fade direction="right" triggerOnce>
                ...
                >
                  <div className="absolute -top-6 left-8 p-4 bg-gradient-to-r from-orange-500 to-orange-400 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="py-20 relative overflow-hidden">
        <XLContainer>
          <div className="flex flex-col items-center relative z-10">
            <div className="relative flex flex-col h-fit text-accent px-6 lg:px-0 w-full">
                  ...
                  <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-3xl p-12 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                        ...
                        <br />
                        <span className="text-white">is our success too!</span>
                        <span className="text-3xl ml-4">🏆</span>
                      </h3>
                      <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
                        In this digital era, we have a dedicated team ready to
                        serve our client's needs and ensure complexities are
                        simplified and solutions are flexible.
                      </p>
                    </div>
                  </div>
                </div>
