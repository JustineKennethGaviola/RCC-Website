    ...
    <div className="flex flex-col scroll-smooth bg-gray-100 h-fit w-full">
            ...
            <div className="text-center">
              <Fade direction="down" duration={600}>
                <div className="text-3xl md:text-4xl lg:text-5xl font-semibold pt-24 pb-2 lg:pb-0">
                  <h1 className=" text-white/90">Transform your Ideas into</h1>
              ...
              <Fade direction="up">
                <p className="mt-6 max-w-screen-md clip font-normal mx-auto text-sm lg:text-md leading-7 text-white/90 text-justify">
                  RCC Colab Solutions will collaborate to turn your ideas into
                  innovative, scalable software solutions. By combining
                  cutting-edge solutions and deep industry expertise, we can
                  help keep your organization efficient and productive and
            ...
            <div className="flex flex-col gap-8 text-gray-700 leading-9 text-justify lg:px-14 text-xl">
              ...
              >
                <p>
                  ...
                  understanding that each company has unique needs and goals. We
                  are here to help businesses unlock their full potential
                  through emerging and cutting-edge solutions.
                </p>
                <p>
                  Whether you're a startup or an established company, RCC Colab
                  Solutions is eager to hear about your business initiative and
                  help enhance your digital presence, streamline operations, and
                  improve customer engagement through our innovative software
                  solutions.
                </p>
                <p>
                  We are thrilled to collaborate with your team and identify the
                  best IT services and solutions to create significant value for
                  your organization.
                </p>
              </Fade>
            </div>
                ...
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <p className="text-lg lg:text-xl font-light text-justify leading-relaxed">
                      RCC Colab Solutions believes that businesses should
                      consider modernizing and simplifying older versions of
                      applications to stay competitive in today&apos;s rapidly
              ...
              <div className="grid md:pr-20 lg:pr-0 lg:grid-cols-2 gap-28 lg:min-h-[50vh]">
                ...
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <p className=" text-lg lg:text-xl font-light text-justify  leading-relaxed">
                      We customize software solutions tailored to businesses'
                      specific needs, including web applications, mobile apps,
                      and enterprise software.
                    </p>
                    <button
                      onClick={() =>
                        navigate("/services?s=softwaredevelopment")
                      }
              ...
              <div className="grid md:pr-20 lg:pr-0 lg:grid-cols-2 gap-28 lg:min-h-[50vh]">
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <p className="text-lg lg:text-xl font-light text-justify leading-relaxed">
                      We offer strategic guidance on how technology can help
                      business objectives, including IT road mapping outlining
                      your existing IT environment and the actions you shouldt
                      take to reduce risks and reach their goals.
                    </p>
                    <button
                      onClick={() =>
                        navigate("/services?s=itstrategyconsulting")
                      }
                      className="flex group items-center gap-3 mt-8 lg:mt-12 text-accent font-medium ring-4 ring-cyan-400/20 rounded-lg text-lg md:text-md lg:text-lg px-6 py-2 tracking-wider bg-cyan-400"
                    >
                      Learn more
                ...
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <p className=" text-lg lg:text-xl font-light text-justify  leading-relaxed">
                      ...
                      comprehensive RPA services designed to help your business
              ...
              <div className="grid md:pr-20 lg:pr-0 lg:grid-cols-2 gap-28 lg:min-h-[50vh]">
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <p className="text-lg lg:text-xl font-light text-justify leading-relaxed">
                      In today's dynamic business environment, having the right
                      talent at the right time is crucial for maintaining a
                      competitive edge. Our Staff Augmentation services give
                      your organization the flexibility and expertise to meet
                      project demands, fill skill gaps, and drive growth. At RCC
                      Colab Solutions, we offer comprehensive staff augmentation
                      solutions that align with your specific requirements and
                      business objectives.
                    </p>
                    <button
              ...
              <div className="grid md:pr-20 lg:pr-0 lg:grid-cols-2 gap-28 lg:min-h-[50vh]">
                ...
                <div className="text-white/90">
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        navigate("/services?s=supportandmaintenance")
                      }
                      className="flex group lg:ml-auto items-center gap-3 mt-8 lg:mt-12 text-accent font-medium ring-4 ring-cyan-400/20 rounded-lg text-lg md:text-md lg:text-lg px-6 py-2 tracking-wider bg-cyan-400"
                    >
                      Learn more
      ...
      <div className="h-fit">
        <XLContainer>
          <div className="flex flex-col items-center">
            <Zoom>
              <h1 className="text-3xl md:text-4xl lg:text-5xl text-gray-900 text-center font-semibold leading-relaxed px-6 pt-18 pb-10">
                The success of our clients <br /> is our success too!
                <span className="hidden lg:block">🏆</span>
              </h1>
              <p className="text-xl text-gray-700 max-w-screen-md text-center px-6 lg:px-0 leading-8 pb-36">
                In this digital era, we have a dedicated team keen to serve our
                client&apos;s needs and ensure the complexities simplified and
                flexible.
              </p>
            </Zoom>
          </div>
      ...
      <div
        ...
        style={{
          clipPath: "polygon(50% 40%, 100% 0,  100% 100%,   0 100%, 0 0)",
        }}
      ></div>
    </div>
  );
